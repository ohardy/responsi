...
(function() {
  var exports, icons, nodes, path, plugin, stylus, utils;
  ...
  exports = module.exports = plugin = function() {
    return function(style) {
      ...
      style.define('responsi-icons', icons);
      return style.define('responsi-get-icon-content', function(name) {
        return new nodes.String(icons[name.val]);
      });
    };
  };
